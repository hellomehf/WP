        ...
        <div class="tab-pane fade show active" id="tab-item-register" role="tabpanel" aria-labelledby="register-tab">
          <div class="register-form">
            <form method="POST" action="#" name="register-form" class="needs-validation" novalidate="">
              ...
              <div class="form-floating mb-3">
                <input id="password" type="text" class="form-control form-control_gray " name="phonenumber" required=""
              ...
              <div class="customer-option mt-4 text-center">
                ...
                <a href="{{route('login.form')}}" class="btn-text js-show-register">Login to your Account</a>
              </div>
            </form>
          </div>
        </div>
