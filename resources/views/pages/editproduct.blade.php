...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <!-- form-add-product -->
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('update.product')}}">
            @csrf
            @method('PUT')
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        ...
                        <input class="mb-10" type="text" placeholder="Enter Expire Months" name="expire_month"
                            tabindex="0" value="{{$product->expire_month}}" aria-required="true" required="">
                    </fieldset>
                    @error('expire_month')
                      <span class="alert alert-danger text-center">{{$message}}</span>
                    @enderror
